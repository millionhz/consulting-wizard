...
import SignUp from '../src/pages/client/SignUpPage';
...
describe('SignUp', () => {
  ...
  it('When no input is provided, Submit Button is disabled', () => {
  ...
  it('Error with invalid password', () => {
    render(<SignUp />);
    jest.spyOn(window, 'alert').mockImplementation(() => {});
  ...
  it('Error when password & confirm password do not match', () => {
    render(<SignUp />);
    const fname = screen.getByPlaceholderText('Enter your first name');
    const lname = screen.getByPlaceholderText('Enter your last name');
    const email = screen.getByPlaceholderText('Enter your LUMS email');
