...
import ManageProfilePage from '../src/pages/client/ManageProfilePage';
...
describe('Testing Profile Updates', () => {
  ...
  it('edit display name', async () => {
    ...
    // wait for the API call to complete and check that the user profile information was updated
    // await waitFor(() => {
