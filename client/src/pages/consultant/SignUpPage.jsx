...
import { signUpConsultant } from '../../api/backend';
...
function SignUpPage() {
  ...
  return (
    <div>
      ...
      <Container>
        <Header>Fill in the details to join us as a Counselor!</Header>
        <SignUpForm>
          <FormInputDiv
            label="First Name"
            type="text"
          ...
          <FormInputDiv
            ...
            placeholder="Enter your current university/organization"
            setValue={setCurrentPlacement}
          />
          <FormInputDiv
